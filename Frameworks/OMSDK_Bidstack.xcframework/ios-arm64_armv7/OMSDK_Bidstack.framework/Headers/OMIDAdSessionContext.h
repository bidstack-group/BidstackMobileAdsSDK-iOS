 ...
 */
@interface OMIDBidstackAdSessionContext : NSObject
 ...
 * @see OMIDSDK
 */
- (nullable instancetype)initWithPartner:(OMIDBidstackPartner *)partner
...
- (nullable instancetype)initWithPartner:(OMIDBidstackPartner *)partner
                               ...
                               resources:(NSArray<OMIDBidstackVerificationScriptResource *> *)resources
                              contentUrl:(nullable NSString *)contentUrl
               customReferenceIdentifier:(nullable NSString *)customReferenceIdentifier
                                   error:(NSError *_Nullable *_Nullable)error;
