 ...
 */
@interface OMIDBidstackAdSession : NSObject

/**
 *  The AdSession configuration is used for check owners.
 */
@property(nonatomic, readonly) OMIDBidstackAdSessionConfiguration *configuration;
/**
 ...
 */
- (nullable instancetype)initWithConfiguration:(OMIDBidstackAdSessionConfiguration *)configuration
                              adSessionContext:(OMIDBidstackAdSessionContext *)context
