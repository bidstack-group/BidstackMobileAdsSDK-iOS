 ...
 */
@interface OMIDBidstackAdEvents : NSObject
 ...
 */
- (nullable instancetype)initWithAdSession:(nonnull OMIDBidstackAdSession *)session error:(NSError * _Nullable * _Nullable)error;
 ...
 */
- (BOOL)loadedWithVastProperties:(OMIDBidstackVASTProperties *_Nonnull)vastProperties
