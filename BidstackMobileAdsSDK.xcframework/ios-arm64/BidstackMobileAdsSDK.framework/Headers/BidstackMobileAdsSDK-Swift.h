...
- (void)initializeWithApiKey:(NSString * _Nonnull)key adapterName:(NSString * _Nonnull)adapterName adapterVersion:(NSString * _Nonnull)adapterVersion completionBlock:(void (^ _Nonnull)(BOOL, NSString * _Nullable))completionBlock;
...
- (void)InitializeNetworkFromAdapterName:(NSString * _Nonnull)adapterName appName:(NSString * _Nonnull)appName;
- (void)Destroy;
- (BidstackAdapterInterface * _Nullable)AdapterInterface SWIFT_WARN_UNUSED_RESULT;
+ (void)InitLoggerWithAdapterName:(NSString * _Nonnull)adapterName applicationName:(NSString * _Nonnull)appName;
+ (void)EnableFullVerboseMode;
