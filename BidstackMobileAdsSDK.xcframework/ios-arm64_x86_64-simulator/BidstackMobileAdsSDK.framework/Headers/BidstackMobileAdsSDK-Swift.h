...
- (void)initializeWithApiKey:(NSString * _Nonnull)key adapterName:(NSString * _Nonnull)adapterName completionBlock:(void (^ _Nonnull)(BOOL, NSString * _Nullable))completionBlock SWIFT_DEPRECATED_MSG("Use initialize(apiKey key: String, adapterName: String, adapterVersion: String, completionBlock: @escaping (Bool, String?)->Void)");
